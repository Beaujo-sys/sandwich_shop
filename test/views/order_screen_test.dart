  ...
  group('OrderScreen - Interactions', () {
    ...
    testWidgets('quantity does not go below zero and buttons are disabled',
      ...
      final Finder quantityRow = find.ancestor(
        of: removeButtonFinder,
        matching: find.byType(Row),
      );
      expect(
        find.descendant(of: quantityRow, matching: find.text('0')),
        findsOneWidget,
      );
  ...
  group('StyledButton', () {
    testWidgets('renders correctly with icon and label when enabled',
      ...
      expect(find.text('Test Button'), findsOneWidget);
          ...
          final Finder styledButtonFinder = find.byType(StyledButton);
          final StyledButton button =
            tester.widget<StyledButton>(styledButtonFinder);
